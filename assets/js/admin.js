        ...
        try {
            ...
            const defaultSchemas = {
                ...
                'valtti-tapa': {
                    ...
                    "Arvot Otsikko": "Valttikodit arvot",
                    "Arvot Lainaus": "Suurin osa rakennusten kustannuksista päätetään suunnittelupöydällä. Me haluamme suunnitella ja rakentaa aikaa kestäviä, arjessa toimivia pientaloja, joihin asiakkaalla on varaa. Näin rakentamisen jälkeen asiakkaalla jää rahaa muuhunkin elämiseen ja tarvittaviin hankintoihin.",
                    "Arvot Henkilö": "Jani Junes, Valttikodit Oy",
                    "Tiimi Otsikko": "Henkilöt taustalla",
                    "H1 Nimi": "Jani Junes",
                    "H1 Titteli": "Toimitusjohtaja\nRakennustekniikan insinööri (YAMK)",
                    "H1 Kuva": "",
                    "H2 Nimi": "Tuomo Junes",
                    "H2 Titteli": "Osakas, Talousjohtaja\nRakennustekniikan insinööri (AMK)\nKauppatieteiden tradenomi",
                    "H2 Kuva": "",
                    "H3 Nimi": "Pekka Junes",
                    "H3 Titteli": "Osakas, Kehitysjohtaja\nDatatekniikan tradenomi (AMK)",
                    "H3 Kuva": "",
                    "H4 Nimi": "Sakari Junes",
                    "H4 Titteli": "Osakas, Myyntijohtaja\nRakennustekniikan insinööri (AMK)\nKasvatustieteiden maisteri",
                    "H4 Kuva": "",
                    "Prosessi Otsikko": "Miten etenemme?",
                    "P1 Otsikko": "TOIMITUSSISÄLLÖN VALINTA",
                    "P1 Teksti": "Tilaratkaisujen, sisustusvalintojen ja toimitus-sisällön hyväksyntä",
                    "P2 Otsikko": "SOPIMUKSEN TEKO JA TYÖMAAN KÄYNNISTYS",
                    "P2 Teksti": "Sopimuksen allekirjoitus\nTonttisopimus kunnan kanssa\nTyömaan aloitustoimenpiteiden suunnittelu",
                    "P3 Otsikko": "RAKENNUSVAIHE ~ 7kk",
                    "P3 Teksti": "Erikoissuunnittelun käynnistys\nTyömaan käynnistys\nSeurantapalaverit ja muuttopäivän varmistus\nSuunnittelukatselmus / lupasuunnitteluvaiheen tarkastus\nRakennusvaiheen välikatselmus (ennen lattian valua)\nSisustuskatselmus / pintakatselmus\nEsikatselmus (preluovutus)",
                    "P4 Otsikko": "KÄYTTÖÖNOTTO JA MUUTTO",
                    "P4 Teksti": "Käyttöönottokatselmus\nAsiakkaalle avainten luovutus\nHuoltokatselmus 1kk\nTakuukatselmus 1v"
                },
                'yhteys': {
